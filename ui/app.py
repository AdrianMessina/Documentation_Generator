"""
Power BI Documentation Generator v4.0 - VERSIÓN OFICIAL
Interfaz completa con PBIP + TODOS los campos opcionales
"""
...
# Page config
st.set_page_config(
    page_title="Power BI Doc Generator - Simple",
    page_icon="📊",
    layout="centered"
)
...
# Header
st.markdown('<div class="main-title"><h1>📊 Generador de Documentación Power BI v4.0</h1><p>Interfaz Completa | Versión 4.0.0 | 16-Mar-2026</p></div>', unsafe_allow_html=True)
...
manual_path_input = st.text_input(
    ...
    help="Edita esta ruta si necesitas usar otro archivo"
)
...
if generate:
    try:
        ...
        uploaded_er = st.session_state.get('er_image')
        uploaded_viz = st.session_state.get('viz_images', [])
